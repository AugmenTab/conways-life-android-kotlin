...
class TerrainView : View {
    ...
    var saturation: Float
        ...
        set(saturation: Float) {
            this._saturation = MAX_SATURATION.coerceAtMost(0f.coerceAtLeast(saturation))
            colorsUpdated = false
        }
    ...
    var newBrightness: Float
        ...
        set(newBrightness: Float) {
            this._newBrightness = MAX_BRIGHTNESS.coerceAtMost(0f.coerceAtLeast(newBrightness))
            colorsUpdated = false
        }
    ...
    var oldBrightness: Float
        ...
        set(oldBrightness: Float) {
            this._oldBrightness = MAX_BRIGHTNESS.coerceAtMost(0f.coerceAtLeast(oldBrightness))
            colorsUpdated = false
        }
